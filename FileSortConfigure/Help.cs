...
------------------------------------------------------------------------------ -
    ...
    Если хотите удалить дерикторию из списка дерикторий В которые нужно собирать - нажмите по ней левой кнопкой мыши, после чего в появившемся окне нажмите на кнопку 'Удалить'.";
            else richTextBox1.Text = @"        Классы символов
